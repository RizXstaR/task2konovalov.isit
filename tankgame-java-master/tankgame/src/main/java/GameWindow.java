...
public class GameWindow extends JFrame {
    ...
    static final String title = "Игра в танки | Коновалов Иван, 13 группа, 2 курс ФКН| Нажми F1 чтобы узреть элементы";
    ...
    GameWindow(JPanel game) {
        ...
        try {
            ...
            System.out.println("IOException: невозможно прочитать файл изображения");
            e.printStackTrace();
        }
